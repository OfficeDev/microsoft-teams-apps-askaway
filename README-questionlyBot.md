...
3. Give the bot a handle (ex: `questionlyBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://questionly.azurewebsites.net/api/messages`

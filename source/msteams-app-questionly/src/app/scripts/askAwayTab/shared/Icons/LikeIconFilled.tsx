...
const svgContent = (classes, props) => {
    return (
        <svg role="presentation" focusable="false" viewBox="8 8 16 16" className={classes.svg} style={props.style}>
            <path
                style={{ display: 'block' }}
...
export const LikeIconFilled = createSvgIcon({
    svg: ({ classes, props }) => svgContent(classes, props),

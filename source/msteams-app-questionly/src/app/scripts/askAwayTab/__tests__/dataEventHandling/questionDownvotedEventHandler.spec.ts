...
describe('validates QuestionDownvotedEventHandler', () => {
    let questionDownvotedEventHandler;
    ...
    beforeAll(() => {
        questionDownvotedEventHandler = new QuestionDownvotedEventHandler();
    ...
    it('current active session data is null', async () => {
        questionDownvotedEventHandler.handleEvent(testEventData, null, mockUpdateQnASessionContent, mockShowNewUpdatesButton, mockUpdateActiveSessionData);
    ...
    it('event does not correspond to current active session data', async () => {
        ...
        questionDownvotedEventHandler.handleEvent(testEventData, activeSessionData, mockUpdateQnASessionContent, mockShowNewUpdatesButton, mockUpdateActiveSessionData);
    ...
    it('content is already up to date with question', async () => {
        ...
        testEventData.data = {
            questionId: 'test',
            downvotedByUserAadObjectId: 'testUser',
        };
    ...
    it('content is not up to date with question - question is upvoted', async () => {
        activeSessionData.unansweredQuestions = [
            {
                id: 'test',
                content: '',

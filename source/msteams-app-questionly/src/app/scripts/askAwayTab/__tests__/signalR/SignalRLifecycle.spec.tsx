...
describe('SignalRLifecycle Component', () => {
    ...
    it('should render fine with no alert', async () => {
        const wrapper = shallow(
            <SignalRLifecycle conversationId={testConversationId} onEvent={updateEventCallback} appInsights={sampleAppInsights} httpService={sampleHttpService} connection={hubConnection} />
        );
        await waitForAsync();
        wrapper.update();
